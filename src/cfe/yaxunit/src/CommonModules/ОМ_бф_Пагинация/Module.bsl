...
Функция ТекстЗапросаДляПроверкиПагинацииССозданиемИВыборомИзВТ() Экспорт
	...
	|	ПереименованнаяВТ.Ключ КАК Ключ,
	|	ПереименованнаяВТ.Значение КАК Значение,
	|	ПраваяТаблица.Автор КАК Автор,
	|	ПраваяТаблица.ДатаУстановки КАК ДатаУстановки,
	|	ПереименованнаяВТ.Справочник.Представление КАК СправочникПредставление1,
	|	ПереименованнаяВТ.Справочник.Представление КАК СправочникПредставление2,
	|	ПереименованнаяВТ.Справочник.Представление КАК СправочникПредставление3
	|ИЗ
